...
ylabel('Current (pA/pF)')
xlabel('Time (ms)')
legend('I_{Kto}','I_{Kslow}','I_{Kss}', 'I_{Na}', 'I_{CaL}')
...
% [t1, ~, A1] = IKsum(init_param_wt, holding_p, holding_t, P1, P1_t, Ek);
[t1, ~, A1] = IKsum(init_param_wt, holding_p, holding_t, P1, P1_t, Ek);
...
IKsum_trc = IKsum_rdc + Iss;

plot(t1, IKsum_trc, 'LineWidth',2, 'Color','red')
hold on
