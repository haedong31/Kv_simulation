...
function [RATES, ALGEBRAIC] = computeRates(X, VOI, STATES, CONSTANTS)
    ...
    % IKslow2
    RATES(:,42) = (ALGEBRAIC(:,72) - STATES(:,34))./ALGEBRAIC(:,74);
    RATES(:,43) = (ALGEBRAIC(:,73) - STATES(:,35))./ALGEBRAIC(:,75);
    ALGEBRAIC(:,72) = 1.00000./(1.00000+exp( - (STATES(:,1)+X(13))./X(14)));
    ALGEBRAIC(:,73) = 1.00000./(1.00000+exp((STATES(:,1)+X(15))./X(16)));
    ALGEBRAIC(:,74) =  0.493000.*exp(  - 0.0629000.*STATES(:,1))+2.05800;
    ALGEBRAIC(:,75) = X(71) - 170.000./(1.00000+exp((STATES(:,1)+45.2000)./5.70000));
    ALGEBRAIC(:,76) =  X(18).*STATES(:,42).*STATES(:,43).*(STATES(:,1) - ALGEBRAIC(:,60));

    RATES(:,1) =  - (ALGEBRAIC(:,47)+ALGEBRAIC(:,49)+ALGEBRAIC(:,51)+ALGEBRAIC(:,55)+ALGEBRAIC(:,58)+ALGEBRAIC(:,59)+ALGEBRAIC(:,69)+ALGEBRAIC(:,61)+ALGEBRAIC(:,66)+ALGEBRAIC(:,71)+ALGEBRAIC(:,1)+ALGEBRAIC(:,76));
    RATES = RATES';
end
