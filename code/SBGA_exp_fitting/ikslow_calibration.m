function [par, amp_diff, tau_diff] = ikslow_calibration(amp, tau, volts_input, N1, N2, verbose)
    ...
    % run calibration
    N0 = N1 + N1*N2;
    [par, amp_diff, tau_diff] = kslow_sbga(amp, tau, N0, N1, N2, verbose);
end

function [last_chrom, last_amp_diff, last_tau_diff] = kslow_sbga(amp, tau, N0, N1, N2, verbose)
    global num_var;
    global max_iter;
    global window_size;
    global log_interval;
