...
function [RATES, ALGEBRAIC] = computeRates(VOI, STATES, CONSTANTS)
    ...
    RATES(:,10) =  CONSTANTS(:,37).*(STATES(:,3) .^ CONSTANTS(:,41)).*STATES(:,9) -  CONSTANTS(:,38).*STATES(:,10);
    RATES(:,11) =  CONSTANTS(:,39).*STATES(:,9) -  CONSTANTS(:,40).*STATES(:,11);
    ALGEBRAIC(:,2) = 1.00000 - (STATES(:,11)+STATES(:,9)+STATES(:,10));
    RATES(:,9) = ( CONSTANTS(:,35).*(STATES(:,3) .^ CONSTANTS(:,42)).*ALGEBRAIC(:,2)+ CONSTANTS(:,38).*STATES(:,10)+ CONSTANTS(:,40).*STATES(:,11)) - ( CONSTANTS(:,36).*STATES(:,9)+ CONSTANTS(:,37).*(STATES(:,3) .^ CONSTANTS(:,41)).*STATES(:,9)+ CONSTANTS(:,39).*STATES(:,9));
    ...
    ALGEBRAIC(:,13) = ( 0.400000.*(exp(((STATES(:,1)+12.0000)./10.0000))).*((1.00000+ 0.700000.*(exp(( - ((STATES(:,1)+40.0000) .^ 2.00000)./10.0000)))) -  0.750000.*(exp(( - ((STATES(:,1)+20.0000) .^ 2.00000)./400.000)))))./(1.00000+ 0.120000.*(exp(((STATES(:,1)+12.0000)./10.0000))));
    ...
    ALGEBRAIC(:,35) =  13.0000.*(1.00000 - (exp(( - ((STATES(:,1)+14.5000) .^ 2.00000)./100.000))));
    ...
    ALGEBRAIC(:,30) = (1.00000+( CONSTANTS(:,19).*CONSTANTS(:,21))./((CONSTANTS(:,21)+STATES(:,4)) .^ 2.00000)) .^ ( - 1.00000);
    ...
    ALGEBRAIC(:,43) = ( CONSTANTS(:,30).*(STATES(:,2) .^ 2.00000))./((CONSTANTS(:,31) .^ 2.00000)+(STATES(:,2) .^ 2.00000));
    ...
    RATES(:,26) = ( ALGEBRAIC(:,14).*STATES(:,27)+ ALGEBRAIC(:,38).*STATES(:,25)+ ALGEBRAIC(:,44).*STATES(:,26)) - ( ALGEBRAIC(:,36).*STATES(:,26)+ ALGEBRAIC(:,27).*STATES(:,26)+ ALGEBRAIC(:,42).*STATES(:,26));
    ...
    ALGEBRAIC(:,25) = (1.00000+( CONSTANTS(:,18).*CONSTANTS(:,20))./((CONSTANTS(:,20)+STATES(:,3)) .^ 2.00000)) .^ ( - 1.00000);
    ...
    RATES(:,6) =   - 0.0400000.*STATES(:,6) -  (( 0.100000.*ALGEBRAIC(:,47))./CONSTANTS(:,34)).*(exp(( - ((STATES(:,1) - 5.00000) .^ 2.00000)./648.000)));
    ...
    ALGEBRAIC(:,49) = ( CONSTANTS(:,48).*(STATES(:,2) .^ 2.00000))./((CONSTANTS(:,49) .^ 2.00000)+(STATES(:,2) .^ 2.00000));
    ALGEBRAIC(:,51) =  (( (( (( CONSTANTS(:,50).*1.00000)./((CONSTANTS(:,51) .^ 3.00000)+(CONSTANTS(:,8) .^ 3.00000))).*1.00000)./(CONSTANTS(:,52)+CONSTANTS(:,9))).*1.00000)./(1.00000+ CONSTANTS(:,53).*(exp((( (CONSTANTS(:,54) - 1.00000).*STATES(:,1).*CONSTANTS(:,12))./( CONSTANTS(:,10).*CONSTANTS(:,11))))))).*( (exp((( CONSTANTS(:,54).*STATES(:,1).*CONSTANTS(:,12))./( CONSTANTS(:,10).*CONSTANTS(:,11))))).*(STATES(:,19) .^ 3.00000).*CONSTANTS(:,9) -  (exp((( (CONSTANTS(:,54) - 1.00000).*STATES(:,1).*CONSTANTS(:,12))./( CONSTANTS(:,10).*CONSTANTS(:,11))))).*(CONSTANTS(:,8) .^ 3.00000).*STATES(:,2));
    ...
    ALGEBRAIC(:,12) = (1.00000+( CONSTANTS(:,18).*CONSTANTS(:,20))./((CONSTANTS(:,20)+STATES(:,2)) .^ 2.00000)) .^ ( - 1.00000);
    ...
    ALGEBRAIC(:,69) = ( (( CONSTANTS(:,66).*ALGEBRAIC(:,68).*1.00000)./(1.00000+((CONSTANTS(:,67)./STATES(:,19)) .^ 1.50000))).*CONSTANTS(:,7))./(CONSTANTS(:,7)+CONSTANTS(:,68));
    ...
    ALGEBRAIC(:,61) =  CONSTANTS(:,58).*(STATES(:,29) .^ 3.00000).*STATES(:,30).*(STATES(:,1) - ALGEBRAIC(:,60));
    ...
    ALGEBRAIC(:,64) =  CONSTANTS(:,60).*(STATES(:,33) .^ 2.00000).*(STATES(:,1) - ALGEBRAIC(:,60));
